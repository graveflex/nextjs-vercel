...
export default async function Layout({ children, locale, draft, showHeader }: LayoutProps) {
  ...
  return <LayoutClient showHeader={showHeader} {...navData}>{children}</LayoutClient>;
}
