...
ALTER TABLE "pages_blocks_card_grid_block_cards" ADD COLUMN IF NOT EXISTS "card_date" varchar;
ALTER TABLE "_pages_v_blocks_card_grid_block_cards" ADD COLUMN IF NOT EXISTS "card_date" varchar;
