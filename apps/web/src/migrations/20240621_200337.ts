...
ALTER TABLE "pages_blocks_text_image_block" ADD COLUMN "textinput_placeholder" varchar;
ALTER TABLE "pages_blocks_text_image_block" ADD COLUMN "textinput_help_text" varchar;
ALTER TABLE "pages_blocks_text_image_block" ADD COLUMN "textinput_label" varchar;
...
ALTER TABLE "_pages_v_blocks_text_image_block" ADD COLUMN "textinput_placeholder" varchar;
ALTER TABLE "_pages_v_blocks_text_image_block" ADD COLUMN "textinput_help_text" varchar;
ALTER TABLE "_pages_v_blocks_text_image_block" ADD COLUMN "textinput_label" varchar;
...
ALTER TABLE "pages_blocks_text_image_block" DROP COLUMN IF EXISTS "textinput_placeholder";
ALTER TABLE "pages_blocks_text_image_block" DROP COLUMN IF EXISTS "textinput_help_text";
ALTER TABLE "pages_blocks_text_image_block" DROP COLUMN IF EXISTS "textinput_label";
...
ALTER TABLE "_pages_v_blocks_text_image_block" DROP COLUMN IF EXISTS "textinput_placeholder";
ALTER TABLE "_pages_v_blocks_text_image_block" DROP COLUMN IF EXISTS "textinput_help_text";
ALTER TABLE "_pages_v_blocks_text_image_block" DROP COLUMN IF EXISTS "textinput_label";
