// Types
import type { ContactSectionsBlockT as PayloadType } from '@mono/types/payload-types';
...
export type ContactSectionsBlockType = Omit<PayloadType, 'blockType'>;
...
function ContactSectionsBlock({ variant, ...props }: ContactSectionsBlockType) {
