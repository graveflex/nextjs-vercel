...
export default function Variant6() {
  return (
    <aside
      ...
      className="absolute top-16 left-0 right-0 mx-auto px-6"
    >
      <div className="flex items-center bg-primary-foreground pl-4 pr-6 py-3 md:py-4 relative rounded-xl shadow-lg max-w-5xl mx-auto">
        <Link
          href="#"
        ...
        >
          ...
          <ChevronsRight
            className="hidden md:block w-4 h-4 text-foreground"
            aria-hidden="true"
          />
        </Link>
        <button
